...
e=e-this.offsetLeft-a.offsetWidth/2;f=(f-this.offsetTop-a.offsetHeight/2);var qwe = ((window.pageYOffset || document.scrollTop)  - (document.clientTop || 0));if(isNaN(qwe)){qwe=0;} f=f-qwe;a.style.top=a.offsetHeight/2+"px";a.style.left=a.offsetWidth/2+"px";a.classList.add("animate")});

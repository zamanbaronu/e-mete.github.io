...
e=e-this.offsetLeft-a.offsetWidth/2;f=(f-this.offsetTop-a.offsetHeight/2)-((window.pageYOffset || doc.scrollTop)  - (doc.clientTop || 0));a.style.top=f+"px";a.style.left=e+"px";a.classList.add("animate")});

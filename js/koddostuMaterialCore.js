...
e=e-this.offsetLeft-a.offsetWidth/2;f=(f-this.offsetTop-a.offsetHeight/2);var qwe = ((window.pageYOffset || doc.scrollTop)  - (doc.clientTop || 0));f=f-qwe;a.style.top=f+"px";a.style.left=e+"px";a.classList.add("animate")});
